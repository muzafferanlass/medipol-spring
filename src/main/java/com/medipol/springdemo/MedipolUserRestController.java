...
public class MedipolUserRestController {
    ...
    public List<User> addUser(@RequestParam String name, @RequestParam String surName, @RequestParam String productadd){

        userService.addUser(name, surName,productadd);
